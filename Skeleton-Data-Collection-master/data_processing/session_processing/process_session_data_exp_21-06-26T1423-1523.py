...
if __name__ == '__main__':
    ...
    a_time_logger = '/media/zhenyue-qin/Seagate Expansion Drive2/Collected-Skeleton-Data-Backup/Skeleton-Data-Collection/time_logger/saved_csv/2021-06-26T14-26-55_action_log.csv'
    a_save_root = f'../2021-06-26T14:30-15:30-Azure-'

    # Azure 1
    a_skeleton_path_1 = '/media/zhenyue-qin/Skeleton-1/Azure-1-Data/skeletonData-2021-06-26--14-23-40.txt'
    a_rgb_path_1 = a_skeleton_path_1.replace('skeletonData-', 'RGBImages').replace('.txt', '')
    a_save_root_1 = a_save_root + '1-BASE'

    # Azure 2
    # a_skeleton_path_2 = '/media/zhenyue-qin/Seagate Expansion Drive2/Azure-2-Data/skeletonData-2021-06-25--14-29-13.txt'
    # a_rgb_path_2 = '/media/zhenyue-qin/Seagate Expansion Drive2/Azure-2-Data/RGBImages2021-06-25--14-29-13'
    # a_save_root_2 = a_save_root + '2-BASE'

    # Azure 3
    # a_skeleton_path_3 = '/media/zhenyue-qin/Seagate Expansion Drive/Azure-3-Data/skeletonData-2021-06-26--14-23-50.txt'
    # a_rgb_path_3 = '/media/zhenyue-qin/Seagate Expansion Drive/Azure-3-Data/RGBImages2021-06-26--14-23-50'
    # a_save_root_3 = a_save_root + '3-BASE'

    # Azure 4
    # a_skeleton_path_4 = '/media/zhenyue-qin/HCC-Drive-4/Azure-4-Data/skeletonData-2021-06-26--14-23-55.txt'
    # a_rgb_path_4 = '/media/zhenyue-qin/HCC-Drive-4/Azure-4-Data/RGBImages2021-06-26--14-23-55'
    # a_save_root_4 = a_save_root + '4-BASE'

    # Azure 5
    # a_skeleton_path_5 = '/media/zhenyue-qin/HCC-Drive-5/Azure-5-Data/skeletonData-2021-06-26--14-24-02.txt'
