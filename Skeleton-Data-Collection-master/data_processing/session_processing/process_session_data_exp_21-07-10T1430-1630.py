...
class SkeletonSessionDataProcessor:
    def __init__(self, time_logger_csv_path, skeleton_file_path, rgb_file_path,
        ...
        # check integrity
        assert save_root[6:16] in self.time_logger_csv_path and \
               save_root[6:16] in self.skeleton_file_path and \
               save_root[6:16] in self.rgb_file_path
...
if __name__ == '__main__':
    ...
    a_time_logger = '/media/zhenyue-qin/Seagate Expansion Drive/Collected-Skeleton-Data-Backup/Skeleton-Data-Collection/time_logger/saved_csv/2021-07-10T14-30-54_action_log.csv'
    a_save_root = f'../../2021-07-10T14:30-16:30-Azure-'

    # Azure 1
    # a_skeleton_path_1 = '/media/zhenyue-qin/Skeleton-1/Azure-1-Data/skeletonData-2021-07-10--14-30-44.txt'
    # a_rgb_path_1 = a_skeleton_path_1.replace('skeletonData-', 'RGBImages').replace('.txt', '')
    # a_save_root_1 = a_save_root + '1-BASE'

    # Azure 2
    # a_skeleton_path_2 = '/media/zhenyue-qin/Seagate Expansion Drive3/Azure-2-Data/skeletonData-2021-07-10--14-30-26.txt'
    # a_rgb_path_2 = a_skeleton_path_2.replace('skeletonData-', 'RGBImages').replace('.txt', '')
    # a_save_root_2 = a_save_root + '2-BASE'

    # Azure 3
    # a_skeleton_path_3 = '/media/zhenyue-qin/Seagate Expansion Drive2/Azure-3-Data/skeletonData-2021-07-10--14-30-22.txt'
    # a_rgb_path_3 = a_skeleton_path_3.replace('skeletonData-', 'RGBImages').replace('.txt', '')
    # a_save_root_3 = a_save_root + '3-BASE'

    # Azure 4
    # a_skeleton_path_4 = '/media/zhenyue-qin/Skeleton-4/Azure-4-Data/skeletonData-2021-07-10--14-30-10.txt'
    # a_rgb_path_4 = a_skeleton_path_4.replace('skeletonData-', 'RGBImages').replace('.txt', '')
    # a_save_root_4 = a_save_root + '4-BASE'

    # Azure 5
    a_skeleton_path_5 = '/media/zhenyue-qin/HCC-Drive-5/Azure-5-Data/skeletonData-2021-07-10--14-30-05.txt'
    a_rgb_path_5 = a_skeleton_path_5.replace('skeletonData-', 'RGBImages').replace('.txt', '')
