...
if __name__ == '__main__':
    ...
    a_time_logger = '/media/zhenyue-qin/Seagate Expansion Drive/Collected-Skeleton-Data-Backup/Skeleton-Data-Collection/time_logger/saved_csv/2021-06-22T15-17-35_action_log.csv'
    a_save_root = f'../2021-06-22T15:17-17:17-Azure-'

    # Azure 1
    # a_skeleton_path_1 = '/media/zhenyue-qin/One Touch/Azure-1-Data/skeletonData-2021-06-22--15-12-06.txt'
    # a_rgb_path_1 = '/media/zhenyue-qin/One Touch/Azure-1-Data/RGBImages2021-06-22--15-12-06'
    # a_save_root_1 = a_save_root + '1-BASE'

    # Azure 2
    a_skeleton_path_2 = '/media/zhenyue-qin/Seagate Expansion Drive2/Azure-2-Data/skeletonData-2021-06-22--15-12-12.txt'
    a_rgb_path_2 = '/media/zhenyue-qin/Seagate Expansion Drive2/Azure-2-Data/RGBImages2021-06-22--15-12-13'
    a_save_root_2 = a_save_root + '2-BASE'

    # Azure 3
    # a_skeleton_path_3 = '/media/zhenyue-qin/Elements/Azure-3-Data/skeletonData-2021-06-22--15-11-49.txt'
    # a_rgb_path_3 = '/media/zhenyue-qin/Elements/Azure-3-Data/RGBImages2021-06-22--15-11-49'
    # a_save_root_3 = a_save_root + '3-BASE'

    # Azure 4
    # a_skeleton_path_4 = '/media/zhenyue-qin/Seagate Expansion Drive2/Azure-4-Data/skeletonData-2021-06-19--19-11-06.txt'
    # a_rgb_path_4 = '/media/zhenyue-qin/Seagate Expansion Drive2/Azure-4-Data/RGBImages2021-06-19--19-11-06'
    # a_save_root_4 = a_save_root + '4-BASE'

    # Azure 5
    # a_skeleton_path_5 = '/media/zhenyue-qin/HCC-Drive-5/Azure-5-Data/skeletonData-2021-06-22--15-11-57.txt'
    # a_rgb_path_5 = '/media/zhenyue-qin/HCC-Drive-5/Azure-5-Data/RGBImages2021-06-22--15-11-57'
    # a_save_root_5 = a_save_root + '5-BASE'

    a_skeleton_path_to_use = a_skeleton_path_2
    a_rgb_path_to_use = a_rgb_path_2
    a_save_root_to_use = a_save_root_2

    print('a_skeleton_path_to_use: ', a_skeleton_path_to_use)
    print('a_rgb_path_to_use: ', a_rgb_path_to_use)
    print('a_save_root_to_use: ', a_save_root_to_use)
