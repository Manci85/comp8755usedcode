...
if __name__ == '__main__':
    a_time_logger = '/media/zhenyue-qin/Seagate Expansion Drive/Collected-Skeleton-Data-Backup/Skeleton-Data-Collection/time_logger/saved_csv/2021-06-20T14-15-53_action_log.csv'
    a_save_root = f'../2021-06-20T14:15-16:15-Azure-'

    # Azure 1
    a_skeleton_path_1 = '/media/zhenyue-qin/One Touch/Azure-1-Data/skeletonData-2021-06-20--14-15-47.txt'
    a_rgb_path_1 = '/media/zhenyue-qin/One Touch/Azure-1-Data/RGBImages2021-06-20--14-15-47'
    a_save_root_1 = a_save_root + '1-BASE'

    # Azure 2
    a_skeleton_path_2 = '/media/zhenyue-qin/Seagate Expansion Drive1/Azure-2/skeletonData-2021-06-20--14-15-11.txt'
    a_rgb_path_2 = '/media/zhenyue-qin/Seagate Expansion Drive1/Azure-2/RGBImages2021-06-20--14-15-11'
    a_save_root_2 = a_save_root + '2-BASE'

    # Azure 3
    # a_skeleton_path_3 = '/media/zhenyue-qin/One Touch1/Azure-3-Data/skeletonData-2021-06-18--19-17-11.txt'
    # a_rgb_path_3 = '/media/zhenyue-qin/One Touch1/Azure-3-Data/RGBImages2021-06-18--19-17-11'
    # a_save_root_3 = a_save_root + '3-BASE'

    # Azure 4
    a_skeleton_path_4 = '/media/zhenyue-qin/Seagate Expansion Drive1/Azure-4-Data/skeletonData-2021-06-20--14-14-59.txt'
    a_rgb_path_4 = '/media/zhenyue-qin/Seagate Expansion Drive1/Azure-4-Data/RGBImages2021-06-20--14-14-59'
    a_save_root_4 = a_save_root + '4-BASE'

    # Azure 5
    a_skeleton_path_5 = '/media/zhenyue-qin/5E91-62C1/Azure-5-Data/skeletonData-2021-06-20--14-14-48.txt'
    a_rgb_path_5 = '/media/zhenyue-qin/5E91-62C1/Azure-5-Data/RGBImages2021-06-20--14-14-48'
