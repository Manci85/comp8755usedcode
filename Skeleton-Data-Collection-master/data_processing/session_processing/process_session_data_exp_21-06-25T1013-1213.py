...
if __name__ == '__main__':
    ...
    a_time_logger = '/media/zhenyue-qin/Seagate Expansion Drive2/Collected-Skeleton-Data-Backup/Skeleton-Data-Collection/time_logger/saved_csv/2021-06-25T10-08-10_action_log.csv'
    a_save_root = f'../2021-06-25T10:13-12:13-Azure-'

    # Azure 1
    # a_skeleton_path_1 = '/media/zhenyue-qin/Seagate Expansion Drive/Collected-Skeleton-Data-Backup/Collected-Data/Collected-Data/2021-06-25T10h13-12h13/Azure-1/skeletonData-2021-06-25--10-13-17.txt'
    # a_rgb_path_1 = '/media/zhenyue-qin/One Touch/Azure-1-Data/RGBImages2021-06-25--10-13-17'
    # a_save_root_1 = a_save_root + '1-BASE'

    # Azure 2
    # a_skeleton_path_2 = '/media/zhenyue-qin/Seagate Expansion Drive2/Azure-2-Data/skeletonData-2021-06-25--10-12-46.txt'
    # a_rgb_path_2 = '/media/zhenyue-qin/Seagate Expansion Drive2/Azure-2-Data/RGBImages2021-06-25--10-12-46'
    # a_save_root_2 = a_save_root + '2-BASE'

    # Azure 3
    # a_skeleton_path_3 = '/media/zhenyue-qin/Seagate Expansion Drive/Collected-Skeleton-Data-Backup/Collected-Data/Collected-Data/2021-06-25T10h13-12h13/Azure-3/skeletonData-2021-06-25--10-12-52.txt'
    # a_rgb_path_3 = '/media/zhenyue-qin/Seagate Expansion Drive1/Azure-3-Data/RGBImages2021-06-25--10-12-52'
    # a_save_root_3 = a_save_root + '3-BASE'

    # Azure 4
    a_skeleton_path_4 = '/media/zhenyue-qin/HCC-Drive-4/Azure-4-Data/skeletonData-2021-06-25--10-12-50.txt'
    a_rgb_path_4 = '/media/zhenyue-qin/HCC-Drive-4/Azure-4-Data/RGBImages2021-06-25--10-12-50'
    a_save_root_4 = a_save_root + '4-BASE'

    # Azure 5
    # a_skeleton_path_5 = '/media/zhenyue-qin/Seagate Expansion Drive/Collected-Skeleton-Data-Backup/Collected-Data/Collected-Data/2021-06-25T10h13-12h13/Azure-5/skeletonData-2021-06-25--10-12-45.txt'
    # a_rgb_path_5 = '/media/zhenyue-qin/HCC-Drive-5/Azure-5-Data/RGBImages2021-06-25--10-12-45'
    # a_save_root_5 = a_save_root + '5-BASE'

    a_skeleton_path_to_use = a_skeleton_path_4
    a_rgb_path_to_use = a_rgb_path_4
    a_save_root_to_use = a_save_root_4
