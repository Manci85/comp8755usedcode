...
class GenInputData:
    def __init__(self):
        self.exp_dirs = \
            list(get_immediate_subdirectories(
                '/media/zhenyue-qin/Seagate Expansion Drive2/Collected-Skeleton-Data-Backup/Collected-Data/Collected-Data'
            ))
        ...
        assert len(asym_friendly_actions) == 1
    ...
    def save_data(self, data_type='train'):
        if data_type == 'train':
            ...
            input_save_name = os.path.join('/media/zhenyue-qin/Seagate Expansion Drive2/Collected-Skeleton-Data-Backup/Skeleton-Data-Collection/data_processing/test_feeding_data',
                                           'trn_ind_data_non_violent_{}.npy'.format(asym_friendly_actions[0]))
            label_save_name = os.path.join('/media/zhenyue-qin/Seagate Expansion Drive2/Collected-Skeleton-Data-Backup/Skeleton-Data-Collection/data_processing/test_feeding_data',
                                           'trn_ind_label_non_violent_{}.pkl'.format(asym_friendly_actions[0]))
        elif data_type == 'val':
            tgt_cameras = self.val_cameras
            input_save_name = os.path.join('/media/zhenyue-qin/Seagate Expansion Drive2/Collected-Skeleton-Data-Backup/Skeleton-Data-Collection/data_processing/test_feeding_data',
                                           'val_ind_data_non_violent_{}.npy'.format(asym_friendly_actions[0]))
            label_save_name = os.path.join('/media/zhenyue-qin/Seagate Expansion Drive2/Collected-Skeleton-Data-Backup/Skeleton-Data-Collection/data_processing/test_feeding_data',
                                           'val_ind_label_non_violent_{}.pkl'.format(asym_friendly_actions[0]))
        else:
