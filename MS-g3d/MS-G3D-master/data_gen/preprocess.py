...
if __name__ == '__main__':
    data = np.load('/media/manci/projectdata/MS-g3d/MS-G3D-master/config/test/trn_ind_data_non_violent.npy')
    pre_normalization(data)
    np.save('/media/manci/projectdata/MS-g3d/MS-G3D-master/config/test/trn_ind_data_non_violent.npy', data)
