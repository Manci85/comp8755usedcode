...
if __name__ == '__main__':
    ...
    data_path = "/media/manci/projectdata/MS-g3d/MS-G3D-master/config/val_data_joint.npy"
    label_path = "/media/manci/projectdata/MS-g3d/MS-G3D-master/config/val_label.pkl"
