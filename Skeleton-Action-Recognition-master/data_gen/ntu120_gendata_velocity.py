...
def gendata(file_list, out_path, ignored_sample_path, benchmark, part, save_path):
    existing_name = 'joint_bone_angle_cangle_arms_legs'
    existing_path = '{}/{}_data_{}.npy'.format(out_path, part, existing_name)
    print('existing path: ', existing_path)
    ...
    # print('trying to save: ', '{}/{}_data_joint_velocity.npy'.format(out_path, part))
    np.save('{}/{}_data_{}_velocity.npy'.format(save_path, part, existing_name), fp)


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='NTU-RGB-D 120 Skeleton Data Extraction')
    parser.add_argument('--part1-path', default='../../../Datasets/nturgbd_raw/nturgb+d_skeletons/')
    parser.add_argument('--part2-path', default='../../../Datasets/nturgbd_raw/nturgb+d_skeletons120/')
    parser.add_argument('--ignored-sample-path',
                        default='../../../Datasets/nturgbd_raw/NTU_RGBD120_samples_with_missing_skeletons.txt')
    parser.add_argument('--out-folder', default='../data/ntu/')
    ...
    arg.out_folder = '/data1/zhenyue/Baseline-Implementation/Skeleton-Action-Recognition/2020-CVPR-Liu-MS-G3D/MS-G3D/data/ntu120/'
