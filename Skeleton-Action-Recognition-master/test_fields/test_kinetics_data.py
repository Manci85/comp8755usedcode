...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='../../../Datasets/kinetics_raw')
    parser.add_argument(
        '--out_folder', default='../../../Datasets/kinetics')
    arg = parser.parse_args()
    # arg.data_path = '/data1/zhenyue/Baseline-Implementation/Skeleton-Action-Recognition/2020-CVPR-Liu-MS-G3D/Datasets/kinetics'
    # arg.out_folder = ''
