...
class Model(nn.Module):
    ...
    def __init__(self, in_channels, num_class, graph_args,
        ...
        self.class_layer_0 = StgcnBlock(in_channels, 64, st_kernel_size, self.edge_type, stride=1, residual=False,
                                        **kwargs)
        ...
        self.recon_layer_5 = StgcnBlock(128, 128, (5, spatial_kernel_size), self.edge_type, stride=1, padding=False,
                                        residual=False, **kwargs)
        self.recon_layer_6 = StgcnReconBlock(128 + in_channels, self.in_channels*10,
                                             (1, spatial_kernel_size), self.edge_type, stride=1,
                                             padding=False, residual=False, activation=None, **kwargs)
        ...
        print('self.edge_importance first: ', len(self.edge_importance))
    ...
    def forward(self, x, x_target, x_last, A_act, lamda_act):
        ...
        x_last = x_last.permute(0, 4, 1, 2, 3).contiguous().view(-1, self.in_channels, 1, 25)
        ...
        # print('self.edge_importance second: ', len(self.edge_importance))
        ...
        concat_ = torch.cat((r5, x_last), 1)
        r6, _ = self.recon_layer_6(concat_, self.A * self.edge_importance_recon[6], A_act,
                                   lamda_act)  # [N, 64, 1, 25]
        # print('r6: ', r6.shape)
